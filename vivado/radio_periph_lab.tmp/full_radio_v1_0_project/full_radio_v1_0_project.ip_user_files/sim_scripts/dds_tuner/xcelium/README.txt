...
#
# Generated by export_simulation on Thu Jul 27 22:35:15 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './dds_tuner.sh' script.

./dds_tuner.sh -reset_run
...
./dds_tuner.sh -noclean_files

For more information on the script, please type './dds_tuner.sh -help'.
